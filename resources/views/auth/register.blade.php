                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('dateB') ? ' has-error' : '' }}">
                            <label for="dateB" class="col-md-4 control-label">Fecha de Nacimiento</label>

                            <div class="col-md-6">
                                <input id="dateB" type="text" class="form-control" name="dateB" value="{{ old('dateB') }}" required autofocus>
